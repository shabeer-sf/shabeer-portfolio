...
const Timeline = () => {
  ...
  <h2 className="text-color text-3xl md:text-4xl">Professional Journey</h2>
        ...
        <div className=" px-4 py-10 text-white">
          {experiences.map((exp, index) => (
            <div key={index} className="relative flex gap-6">
              {/* Year Section */}
              <div className="text-right w-32 font-semibold text-gray-300 md:whitespace-nowrap">
                {exp.year}
              </div>
              ...
              {/* Company & Roles */}
              <div>
                <div className="bg-gray-700 text-white px-4 py-2 rounded-lg shadow-md text-lg font-semibold inline-block">
                  {exp.company}
                </div>
                ...
                <div className="ml-8 mt-2">
                  {exp.roles.map((role, idx) => (
                    <div
                      key={idx}
                      className="relative flex items-center space-x-4 my-3"
                    >
                      <div className="w-4 h-4 bg-blue-500 rounded-full absolute left-[-1.5rem]"></div>
